    ...
    <div className="container my-5">
      <div className="text-center py-5 bg-light rounded-5 shadow-sm mb-5 px-3">
        ...
        <p className="lead text-muted mx-auto" style={{ maxWidth: "700px" }}>
          We’ve removed the complexity from the job search. No more endless
          paperwork—just a direct, secure connection between the best talent and
          the best companies.
        </p>
        <div className="mt-4">
      ...
      <div className="row py-5 align-items-center">
        <div className="col-md-6 mb-4 mb-md-0">
          <div className="p-4 bg-white border rounded-4 shadow-sm h-100">
            ...
            <p className="text-muted">
              To empower every professional in East Africa by providing a
              transparent recruitment ecosystem where merit meets opportunity.
              We aim to reduce unemployment by making job discovery as simple as
              a single click.
            </p>
          </div>
        </div>
        <div className="col-md-6">
          <div className="p-4 bg-white border rounded-4 shadow-sm h-100">
            ...
            <p className="text-muted">
              To be the most trusted career partner in the region. We envision a
              world where hiring is data-driven, secure, and accessible to
      ...
      <div className="bg-dark text-white rounded-5 p-5 mt-5 shadow-lg">
        <div className="text-center mb-5">
          <h2 className="fw-bold">Why Use JobhubPortal?</h2>
          <p className="text-success fw-bold text-uppercase small ls-2">
        ...
        <div className="row g-4">
          <div className="col-md-4 text-center">
            <div
              className="bg-success bg-opacity-10 p-3 rounded-circle d-inline-block mb-3"
            ...
            <p className="small text-secondary">
              Instant fee processing and automatic application status updates.
            </p>
          </div>
          <div className="col-md-4 text-center">
            <div
            ...
            <p className="small text-secondary">
              Find the exact role you want with our advanced filtering and
              sorting system.
            </p>
          </div>
          <div className="col-md-4 text-center">
            ...
            <p className="small text-secondary">
              Fully responsive design so you can apply for jobs on the go,
              anywhere.
            </p>
          </div>
        </div>
